...
# a Raspberry Pi in response to magnetic switch response or low battery

# See the README file for details on how to set this up with systemd

# Adapted from Daniel Bull's LiPoPi project - https://github.com/NeonHorizon/lipopi
...
lipopi['low_battery_pin'] = 5

lipopi['shutdown_pin']    = 6
